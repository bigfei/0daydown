...
exports.updateSambaFilename = function(dir) {
  readDir(dir).then(function(files) {
    console.log("Including the sub dir files, there is " + f.length + " inside sharing.");
...
exports.updateMongodbFilesExistence = function(withoutSubDir) {
